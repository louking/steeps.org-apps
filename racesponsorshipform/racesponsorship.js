...
// add paymentoption back when solution / workaround for https://github.com/paypal/paypal-checkout/issues/125 found
//        var formfields = ['organization', 'name','phone', 'street', 'city', 'state', 'zip', 'email', 'race', 'amount', 'level', 'paymentoption', 'comments'];
        var formfields = ['organization', 'name','phone', 'street', 'city', 'state', 'zip', 'email', 'race', 'amount', 'level', 'comments'];
